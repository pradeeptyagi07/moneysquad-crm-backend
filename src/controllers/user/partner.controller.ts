...
import { createPartnerSchema, editPartnerSchema } from '../../validation/partner.schema';
...
export const partnerController = {
    async createPartner(req: Request, res: Response) {
        try {
            ...
            const newPartner = await partnerService.createPartner(validatedData.data, files);
